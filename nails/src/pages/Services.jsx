...
import { ArrowRight, Clock, Sparkles, Layers, Droplet, BookOpen } from 'lucide-react'
...
const PROCESS_CARDS = [
  {
    ...
    items: ['Надання форми', 'Обробка кутикули', 'Очищення пластини'],
  },
  {
    Icon: Layers,
    title: 'Покриття',
    items: ['База', 'Колір', 'Вирівнювання'],
  },
  {
    Icon: Droplet,
    title: 'Догляд',
    items: ['Олійка для кутикули', 'Зволоження', 'Фінальний догляд'],
  },
  {
    Icon: BookOpen,
    title: 'Рекомендації',
    items: ['Як носити покриття довше', 'Коли прийти на корекцію', 'Як доглядати вдома'],
  },
]
    ...
    >
      ...
      <section className="relative z-10 px-8 md:px-12 lg:px-16 xl:px-20 pt-6 pb-28">
        ...
        <motion.div
          ...
          style={{ display: 'flex', gap: 10, marginBottom: 56, height: 110, borderRadius: 18, overflow: 'hidden', position: 'relative' }}
        >
          {ACCENT_PHOTOS.map((src, i) => (
            <div key={i} style={{ flex: i === 0 ? 3 : 2, overflow: 'hidden', borderRadius: 14, position: 'relative' }}>
              <img
                src={src} alt="" aria-hidden
                style={{
                  width: '100%', height: '100%', objectFit: 'cover',
                  opacity: 0.52, filter: 'saturate(0.65)',
                }}
              />
            </div>
          ))}
          ...
          <div style={{
            ...
            background: 'linear-gradient(to bottom, rgba(242,222,228,0.12) 0%, rgba(242,222,228,0.55) 100%)',
            pointerEvents: 'none',
          }} />
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {PROCESS_CARDS.map(({ Icon, title, items }, i) => (
            <motion.div
              key={title}
            ...
            >
              ...
              <div style={{
                ...
                color: 'rgba(200,160,174,0.55)', fontFamily: 'Raleway, sans-serif',
                marginBottom: 8,
              }}>
                0{i + 1}
              </div>
              ...
              <div style={{
                ...
                fontFamily: 'Raleway, sans-serif', letterSpacing: '0.02em', marginBottom: 16,
              }}>
                {title}
              </div>
                ...
                {items.map(item => (
                  <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                    <div style={{
                      ...
                      background: 'rgba(200,160,174,0.55)',
                    }} />
                    <span style={{
